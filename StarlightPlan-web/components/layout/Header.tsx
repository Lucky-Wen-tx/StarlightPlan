...
export default function Header(): React.ReactElement {
  ...
  return (
    <header className="h-12 shrink-0 flex items-center justify-between px-4 bg-white dark:bg-[#1a1a1a] select-none relative z-10 after:absolute after:inset-x-0 after:top-full after:h-1 after:bg-gradient-to-b after:from-black/8 after:to-transparent dark:after:from-black/40">
      {/* 左侧：品牌标题 */}
