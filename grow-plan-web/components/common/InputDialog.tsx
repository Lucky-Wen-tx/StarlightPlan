      ...
      footer={
        <>
          ...
          <button
            ...
            disabled={!canSubmit}
            className="px-4 py-2 text-sm font-medium cursor-pointer rounded-lg bg-blue-600 text-white hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            确认
          </button>
        </>
